...
{
    int a0_schema;
    int a0 = deserialize(x0, a0_schema);
    std::vector<int>(*test_fun)(int) = &test;
    std::vector<int> a1 = test_fun(a0);
    std::vector<int> a2_schema;
    std::string a2 = serialize(a1, a2_schema);
    return(a2);
}
